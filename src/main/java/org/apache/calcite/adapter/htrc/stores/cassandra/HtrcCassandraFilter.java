...
public class HtrcCassandraFilter extends Filter implements HtrcCassandraRel {
	  ...
	  public HtrcCassandraFilter copy(RelTraitSet traitSet, RelNode input,
	      RexNode condition) {
	    return new HtrcCassandraFilter(getCluster(), traitSet, input, condition,
	  ...
	  static class Translator {
	    ...
	    Translator(RelDataType rowType, List<String> partitionKeys, List<String> clusteringKeys,
	      ...
	      this.fieldNames = HtrcCassandraRules.cassandraFieldNames(rowType);
